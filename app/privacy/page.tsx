      ...
      <main className="flex-1 pt-16">
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-brand-charcoal">
          <div className="mx-auto max-w-3xl">
            <h1 className="font-heading text-4xl text-brand-white mb-2">Privacy Policy</h1>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl prose prose-sm prose-invert max-w-none">
            <div className="space-y-8 text-brand-gray leading-relaxed">
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Who we are</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Information we collect</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">How we use your information</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Data retention</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Cookies</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Third-party services</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Your rights</h2>
                <p>
              ...
              <div>
                <h2 className="font-heading text-xl text-brand-white mb-3">Changes to this policy</h2>
                <p>
