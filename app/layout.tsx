...
export const metadata: Metadata = {
  ...
  description:
    "Premium outdoor cinema and event rentals for private events in Southeast Michigan. 4K theater-quality projection, 35-foot screen, concert-grade sound, veteran-owned. 40 miles of Canton, MI with travel beyond by quote.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Premium outdoor cinema and event rentals for private events in Southeast Michigan. 4K theater-quality projection, 35-foot screen, concert-grade sound, veteran-owned.",
