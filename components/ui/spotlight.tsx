...
export function Spotlight({ className, fill = "rgba(107,31,31,0.15)" }: SpotlightProps) {
  return (
    <svg
      className={cn("pointer-events-none absolute z-[1] h-[169%] w-[138%] opacity-100", className)}
