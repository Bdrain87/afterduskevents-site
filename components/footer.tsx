          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-5">
              <a
                ...
                className="text-silver hover:text-ember transition-[color,transform] duration-200 hover:scale-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ember rounded"
              >
